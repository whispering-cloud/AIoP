...
import mods.modularmachinery.RecipePrimer;
    ...
    mods.modularmachinery.RecipeBuilder.newBuilder("tntbugmana", "tnt_easy_bug", 20).addItemInput(<minecraft:sticky_piston>).setChance(0).addItemInput(<minecraft:slime>*8).setChance(0.01).addItemInput(<botania:hourglass>).setChance(0).addItemInput(<minecraft:activator_rail>*2).setChance(0.01).addItemInput(<minecraft:minecart>).setChance(0.01).addItemInput(<minecraft:tnt>).setChance(0.01).addItemInput(<minecraft:sand>).setChance(0.01).addManaOutput(6500).build();
